...
export default function AdminCmsPage() {
  ...
  const [tab, setTab] = useState<Tab>(requestedTab && ['specialties', 'degrees', 'topics', 'sections', 'banners', 'content', 'prescription'].includes(requestedTab) ? requestedTab : 'specialties');
  ...
  useEffect(() => {
    ...
    if (next && ['specialties', 'degrees', 'topics', 'sections', 'banners', 'content', 'prescription'].includes(next) && next !== tab) setTab(next);
  }, [searchParams, tab]);
