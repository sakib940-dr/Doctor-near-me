...
function DoctorVerificationStep({ onError, onNext, onPrevious }: StepProps) {
  ...
  async function submit(e:FormEvent){
    ...
    if(!locked && !evidence?.documents.length && !file){const message='BMDC/NID related অন্তত একটি ছবি বা document নির্বাচন করুন। Save & Next চাপলে এটি upload হবে।';setUploadError(message);onError(message);return;}
    setSaving(true);
    try{
      if(!locked){
