...
import { Ambulance, Bell, Building2, CalendarDays, ChevronRight, Clock3, FileCheck2, Link2, LoaderCircle, LogOut, Settings, ShieldCheck, Stethoscope, UserRound } from 'lucide-react';
      ...
      : role === 'hospital' || role === 'chamber'
        ...
        : role === 'ambulance'
          ...
          : role === 'verification_officer'
            ...
            : [{ icon: ShieldCheck, title: 'Verification queue', detail: 'Pending application review', path: '/verification/reviews' }, { icon: Bell, title: 'প্রশাসনিক কাজ', detail: 'Admin dashboard পরবর্তী step-এ', path: '#' }];
