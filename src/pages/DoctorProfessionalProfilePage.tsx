...
import { getMyDoctorProfile, updateMyDoctorProfile, uploadDoctorPhoto } from '../services/doctorDashboard';
...
export default function DoctorProfessionalProfilePage() {
  ...
  useEffect(() => {
    ...
    getUpazilas(districtId).then(setUpazilas).catch(() => setError('উপজেলার তালিকা লোড করা যায়নি।'));
